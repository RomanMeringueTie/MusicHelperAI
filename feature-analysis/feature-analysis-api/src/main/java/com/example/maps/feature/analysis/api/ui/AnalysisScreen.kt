package com.example.maps.feature.analysis.api.ui
...
import com.example.maps.common.api.ui.utils.TypeWritingText
import com.example.maps.common.api.R as CommonR
import com.example.maps.feature.analysis.api.R
...
fun AnalysisScreen(modifier: Modifier, viewModel: AnalysisViewModel, onBack: () -> Unit) {
    val state = viewModel.listensReview.collectAsState()
